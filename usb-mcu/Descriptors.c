...
const USB_Descriptor_ConfigurationMIDI_t PROGMEM ConfigurationDescriptorMIDI =
{
	...
	.MIDI_Out_Jack_Ext_dst_MIDI_Out =
		{
	...
	.MIDI_Out_Jack_Ext_dst_MIDI_Thru =
		{
			.Header                   = {.Size = sizeof(USB_MIDI_Out_Jack_t), .Type = DTYPE_AudioInterface},
			.Subtype                  = DSUBTYPE_OutputJack,
	...
	.MIDI_Out_Jack_Ext_dst_Internal =
		{
			.Header                   = {.Size = sizeof(USB_MIDI_Out_Jack_t), .Type = DTYPE_AudioInterface},
			.Subtype                  = DSUBTYPE_OutputJack,
	...
	.MIDI_Out_Jack_Emb_from_MIDI_In =
		{
			.Header                   = {.Size = sizeof(USB_MIDI_Out_Jack_t), .Type = DTYPE_AudioInterface},
			.Subtype                  = DSUBTYPE_OutputJack,
	...
	.MIDI_In_Jack_Endpoint_SPC =
		{
			...
			.TotalEmbeddedJacks       = 0x03,
			.AssociatedJackID         = {0x01, 0x02, 0x03}
		},
...
const USB_Descriptor_String_t PROGMEM ManufacturerStringMIDI =
{
	...
	.UnicodeString          = L"xstreamworship.com"
};
...
const USB_Descriptor_String_t PROGMEM ProductStringMIDI =
{
	...
	.UnicodeString          = L"Chi-1p 40"
};

/* Jack descriptive strings */
const USB_Descriptor_String_t PROGMEM MIDIInJackStringMIDI =
{
	.Header                 = {.Size = USB_STRING_LEN(12), .Type = DTYPE_String},
	.UnicodeString          = L"MIDI-In Jack"
};

const USB_Descriptor_String_t PROGMEM MIDIOutJackStringMIDI =
{
	.Header                 = {.Size = USB_STRING_LEN(13), .Type = DTYPE_String},
	.UnicodeString          = L"MIDI-Out Jack"
};

const USB_Descriptor_String_t PROGMEM MIDIThruJackStringMIDI =
{
	.Header                 = {.Size = USB_STRING_LEN(19), .Type = DTYPE_String},
	.UnicodeString          = L"MIDI-Thru/Out2 Jack"
};

const USB_Descriptor_String_t PROGMEM MIDIInInternalStringMIDI =
{
	.Header                 = {.Size = USB_STRING_LEN(16), .Type = DTYPE_String},
	.UnicodeString          = L"MIDI-In Internal"
};

const USB_Descriptor_String_t PROGMEM MIDIOutInternalStringMIDI =
{
	.Header                 = {.Size = USB_STRING_LEN(17), .Type = DTYPE_String},
	.UnicodeString          = L"MIDI-Out Internal"
};
